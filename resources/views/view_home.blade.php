...
@section('isihalaman')
    ...
    <h4>Perpustakaan USM</h4>
        UPT Perpustakaan Institut Teknologi Telkom Surabaya sebagai salah satu perpustakaan perguruan tinggi swasta di Indonesia 
		selama ini juga telah melaksanakan kelima tugas tersebut dalam kegiatan di perpustakaannya untuk mendukung 
		terwujudnya Tri Dharma Perguruan Tinggi. Berbagai upaya dilakukan oleh Perpustakaan kampus sendiri berada 
		ditempat yang cukup representative, mudah diakses baik oleh mahasiswa ataupun kalangan civitas akademika ITTS. 
		Disamping itu juga memiliki ribuan koleksi mulai dari Buku, Jurnal, Majalah, Dokumen Penelitian dan berbagai sumber 
		referensi lain guna menunjang proses pembelajaran di ITTS.
    ...
    <p>
		...
		ditiap tahunnya yaitu dengan rata-rata 5,18 % pertahun. UPT Perpustakaan Institut Teknologi Telkom Surabaya sampai 10 Oktober 2018 
